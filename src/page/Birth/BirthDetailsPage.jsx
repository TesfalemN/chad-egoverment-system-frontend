        ...
        <Col className="pt-4 m-ho-10 ">
          <CustomCard className="pt-4 m-ho-10 pd-ho-10">
            ...
            <span style={{ fontSize: "20px", fontWeight: "bold" }}>
              Birth Certificate of {datas?.birthCertificateData?.birthCertificate?.firstName} {datas?.birthCertificateData?.birthCertificate?.lastname}
            </span>  
          </div>
              <h6 className="mt-4">
              ...
              <Col lg={3} xl={6} md={3} sm={4} className="border-10 p-all-0">
                ...
                {datas?.birthCertificateData?.birthCertificate?.lastName}</strong>
                    ...
                    <tr className="tr">
                      ...
                      <td className="td alnright">
                        <strong>{datas?.birthCertificateData?.birthCertificate?.nationality}</strong>
                      </td>
                    </tr>
                    <tr className="tr">
                      <td className="f-14 text-muted td">Phone Number</td>
                      <td className="td alnright">
                        <strong>{datas?.birthCertificateData?.birthCertificate?.phone_number}</strong>
                      </td>
                    </tr>
                    <tr className="tr">
                      <td className="f-14 text-muted td">Email</td>
                      <td className="td alnright">
                        <strong>{datas?.birthCertificateData?.birthCertificate?.email}</strong>
                      </td>
                    </tr>
              ...
              <Col lg={8} xl={5} md={3} sm={4} className="border-10 p-all-0">
                ...
                <div>
                  <table className="table">
                    ...
                    <tr className="tr">
                      <td className="f-14 text-muted td">Place of Birth | Country</td>
                      <td className="td alnright">
                        <strong>    {" "}
                {
                ...
                <div>
                  <table className="table">
                    <tr className="tr">
                      ...
                      <strong>    {" "}
                {
                  datas?.birthCertificateData?.birthCertificate?.userAddress
                    ?.region
                }</strong>
                      </td>
                    </tr>
