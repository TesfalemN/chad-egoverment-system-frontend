...
export const actionTypes = {
  ...
  SET_BIRTH_DATA: "SET_BIRTH_DATA",
  SET_BUSINESS_APPLICATION_ID: "SET_BUSINESS_APPLICATION_ID",
};

export const set_birth_data = (payload) => {
  return {
    type: actionTypes.SET_BIRTH_DATA,
    payload,
  };
};
